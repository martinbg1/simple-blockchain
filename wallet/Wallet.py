...
node = [test_wallet, test_walelt_2]
...
test_wallet.transaction("Failed attempt", test_wallet.privateKey, 100, node)
print(test_wallet.balance, "\t", test_walelt_2.balance, "\n\n")
test_wallet.transaction(test_walelt_2.publicKey, test_wallet.privateKey, 100, node)
print(test_wallet.balance, "\t", test_walelt_2.balance)
